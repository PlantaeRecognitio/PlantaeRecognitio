...
static async Task<HttpResponseMessage> GetVisionData(Stream stream)
{
    ...
    // Request headers
    client.DefaultRequestHeaders.Add("Prediction-key", ConfigurationManager.AppSettings["CustomVisionPredictionKey"]);
    ...
    var uri = ConfigurationManager.AppSettings["CustomVisionUri"] + queryString;
