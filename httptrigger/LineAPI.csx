...
static async Task<Stream> GetLineContents(string messageId)
{
    ...
    {
        //　認証ヘッダーを追加
        getContentsClient.DefaultRequestHeaders.Add("Authorization", $"Bearer {ConfigurationManager.AppSettings["LINE_CHANNEL_ACCESS_TOKEN"]}");
...
{    
    ...
    using (var client = new HttpClient())
    {
        ...
        //　認証ヘッダーを追加
        client.DefaultRequestHeaders.Add("Authorization", $"Bearer {ConfigurationManager.AppSettings["LINE_CHANNEL_ACCESS_TOKEN"]}");
